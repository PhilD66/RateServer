...
*/
        System.out.println("ExamplesConfig::getEndpointConfigs invoked...");
        if (scanned.contains(RateServer.class)) {
            result.add(ServerEndpointConfig.Builder.create(
                    RateServer.class,
                    "/websocket/rateServer").build());
            System.out.println("/websocket/rateServer found.");
        } else {
            System.out.println("/websocket/rateServer NOT found.");
        }
